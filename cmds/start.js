...
module.exports.run = async (bot, message, args) => {
   ...
   let startMessage = new Discord.RichEmbed()
        .setAuthor("House", "https://i.imgur.com/xyOqBB7.png")
        .setTitle("__**Fortnite Scrims**__")
        .setThumbnail("https://i.imgur.com/D3cwKSi.png")
	...
	-Server: __**Asia | SG, JP**__
        ...
        .setImage("https://i.imgur.com/D3cwKSi.png")
        .setColor("#E96D33")
        .addField("Hosted by" , message.author)
        .setFooter("Developed by House")
	.setTimestamp()
